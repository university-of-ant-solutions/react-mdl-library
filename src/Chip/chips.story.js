...
storiesOf('MDL Chip', module)
  .add('basic chip', () => (
    <div>
      <DocItem render={<Chip label="Basic Chip" />} />
    </div>
  ))
  .add('deletable chip', () => (
    <div>
      <DocItem render={<Chip label="Deletable Chip" onRequestDelete={handleRequestDelete} />} />
    </div>
  ))
  ...
  .add('button chip', () => (
    <div>
      <DocItem render={<Chip type="button" label="Button Chip" onClick={handleClick} />} />
    </div>
  ))
