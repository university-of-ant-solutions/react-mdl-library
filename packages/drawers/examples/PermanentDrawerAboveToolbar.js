...
const debug = require('debug')('react-mdl-library:drawers:examples:PermanentDrawerAboveToolbar')

class PermanentDrawerAboveToolbar extends Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
    ...
    return (
      <DocItem
      render={
        <div className="mdc-typography demo-body__permanent-drawer-above-toolbar" data-gr-c-s-loaded="true" cz-shortcut-listen="true">
          ...
          <div className="demo-content__permanent-drawer-above-toolbar">
            ...
            <header className="mdc-toolbar mdc-elevation--z4">
              <div className="mdc-toolbar__row">
                <section className="mdc-toolbar__section mdc-toolbar__section--align-start mdc-theme--primary-bg mdc-theme--text-primary-on-primary">
                  <span className="mdc-toolbar__title catalog-title">Permanent Drawer Above Toolbar</span>
                </section>
              </div>
            </header>
...
PermanentDrawerAboveToolbar.propTypes = {}

PermanentDrawerAboveToolbar.defaultProps = {}

PermanentDrawerAboveToolbar.displayName = 'PermanentDrawerAboveToolbar'

export default PermanentDrawerAboveToolbar